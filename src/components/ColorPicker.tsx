...
function ColorPicker({
  ...
  return (
    <motion.div
      ...
      className='fixed inset-0 z-50 flex h-[100dvh] w-full items-center justify-center pb-[calc(env(safe-area-inset-bottom)+10vh)] sm:pb-[env(safe-area-inset-bottom)]'
    >
      <motion.div
      ...
      >
        ...
        <div className='flex'>
          <button
            className='block w-full rounded-bl-xl border-r border-t border-r-gray-400/20 border-t-gray-400/20 px-4 py-2 text-gray-800 transition hocus:bg-gray-400/20 dark:text-gray-100'
            onClick={onDismiss}
          >
            Cancel
          </button>
