    ...
    <div>
      ...
      >
        <CopyButton color={colors[1]}>
          <button
            className={clsxm(
              'group flex h-full w-full items-start justify-between p-4 font-mono text-xs',
              'transition focus-visible:outline-none focus-visible:ring focus-visible:ring-inset focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black',
              'rounded-t-lg'
            )}
            style={{
              ...
              <CopyButton color={colors[i]} key={`${type}.${i}.${color}`}>
                <button
                  className={clsxm(
                    ...
                    'transition focus-visible:outline-none focus-visible:ring focus-visible:ring-inset focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black',
                    i === 1 && 'rounded-l-lg lg:hidden',
                    i === 2 && 'lg:rounded-bl-lg',
                    i === 3 && 'rounded-r-lg lg:rounded-tr-none'
                  )}
                  style={{
                ...
                >
                  <div className='relative py-6 font-mono text-xs lowercase'>
                    <span className='break-all px-0.5 transition-opacity group-hover:opacity-0 group-focus-visible:opacity-0'>
                      {color}
                    </span>
